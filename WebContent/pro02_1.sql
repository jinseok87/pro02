...
insert into custom(cusId,cusPw,cusName,address,tel) values('jin','1234','진석','김포','010-1111-2222');
insert into custom(cusId,cusPw,cusName,address,tel) values('admin','1234','관리자','','');
select *from custom;
-- 공지사항 테이블 생성
create table notice(
...
select * from custom;
-- 고객 비밀번호의 암호화
update custom set cuspw="03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4" where cusid="jin";
...
insert into qnaa(title, content, author, lev, parno, sec)  values ("문의 글입니다. 테스트 ", "문의 문의 문희 ? 호박고구마", "jin", 0, 1, "N");
