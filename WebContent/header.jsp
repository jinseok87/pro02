...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	<div class="in_container"> 
	  <a class="navbar-brand" id="logo" href="index.jsp">TEMPUR</a>
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	    <ul class="navbar-nav mr-auto">
	      <li class="nav-item active">
	        <a class="nav-link" href="<%=request.getContextPath()%>/index.jsp"><span class="sr-only">(current)</span></a>
	      </li>
	      <li class="nav-item">
	      ...
	      <li class="nav-item dropdown">
	        ...
	        <div class="dropdown-menu">
	          <a class="dropdown-item" href="GetProductItemListCtrl?cateNo=1">MATTRESS</a>
	          <a class="dropdown-item" href="GetProductItemListCtrl?cateNo=2">PILLOW</a>
	          <div class="dropdown-divider"></div>
	          <a class="dropdown-item" href="GetProductItemListCtrl?cateNo=3">SOFA</a>
	          <a class="dropdown-item" href="GetProductItemListCtrl?cateNo=4">RECLINER</a>
	          <div class="dropdown-divider"></div>
	          <a class="dropdown-item" href="GetProductItemListCtrl?cateNo=5">FRAME</a>
	          <a class="dropdown-item" href="GetProductItemListCtrl?cateNo=6">ACCESSORIES</a>
	        </div>
	      </li>
	      <li class="nav-item dropdown">
